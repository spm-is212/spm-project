...
def verify_task_project_links():
    ...
    try:
        ...
        if tasks_without_project:
            print(f"\n[FAIL] {len(tasks_without_project)} tasks have NO project_id")
        ...
        if tasks_with_invalid_project:
            print(f"\n[FAIL] {len(tasks_with_invalid_project)} tasks reference non-existent projects")
        ...
        if orphaned_subtasks:
            print(f"\n[FAIL] {len(orphaned_subtasks)} subtasks have invalid parent_id")
