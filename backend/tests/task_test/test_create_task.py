...
def test_create_main_task_only_success(client, auth_headers, sample_main_task, patch_crud_for_testing, test_project):
...
def test_create_task_with_subtasks_success(client, auth_headers, sample_main_task, sample_subtasks, patch_crud_for_testing, test_project):
...
def test_create_subtask_without_assignees(client, auth_headers, sample_main_task, patch_crud_for_testing, test_project):
...
def test_create_task_without_auth_fails(client, sample_main_task):
...
def test_create_task_main_task_parent_id_ignored(client, auth_headers, sample_main_task, patch_crud_for_testing, test_project):
