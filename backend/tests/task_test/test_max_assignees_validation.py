...
def test_create_task_with_max_5_assignees_success(client, auth_headers, patch_crud_for_testing, test_project):
...
def test_create_task_with_6_assignees_fails(client, auth_headers, patch_crud_for_testing, test_project):
...
def test_create_subtask_with_6_assignees_fails(client, auth_headers, patch_crud_for_testing, test_project):
...
def test_update_task_with_6_assignees_fails(client, auth_headers, patch_crud_for_testing):
