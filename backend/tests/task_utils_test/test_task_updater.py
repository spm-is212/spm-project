...
class TestTaskUpdater:
    ...
    def test_update_main_task_basic_fields(self, mock_crud, mock_task_in_db):
        ...
        # Act
        result = updater.update_tasks("test-task-id", "manager", ["team1"], main_task=update_data)
    ...
    def test_update_main_task_status_and_priority(self, mock_crud, mock_task_in_db):
        ...
        # Act
        updater.update_tasks("test-task-id", "staff", ["team1"], main_task=update_data)
    ...
    def test_update_main_task_due_date(self, mock_crud, mock_task_in_db):
        ...
        # Act
        updater.update_tasks("test-task-id", "manager", ["team1"], main_task=update_data)
    ...
    def test_staff_cannot_remove_assignees(self, mock_crud):
        ...
        # Act
        result = updater.update_tasks("test-task-id", "staff", ["team1"], main_task=update_data)
    ...
    def test_update_subtasks(self, mock_crud):
        ...
        # Act
        result = updater.update_tasks("main-task-id", "manager", ["team1"], subtasks=subtask_updates)
    ...
    def test_subtask_assignee_permissions_manager(self, mock_crud):
        ...
        # Act
        updater.update_tasks("main-task-id", "manager", ["team1"], subtasks=subtask_updates)
    ...
    def test_subtask_assignee_permissions_staff(self, mock_crud):
        ...
        # Act
        result = updater.update_tasks("main-task-id", "staff", ["team1"], subtasks=subtask_updates)
